...
- R2 dùng signed PUT trực tiếp từ trình duyệt; local dùng storage private dự phòng.
- Route xem/tải kiểm tra session + enrollment, dùng signed GET 5 phút trên R2.
